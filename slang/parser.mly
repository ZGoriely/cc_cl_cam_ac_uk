...
%token<int> INT
%token<string> IDENT
%token EOF LPAREN RPAREN COMMA COLON SEMICOLON ADD SUB MUL DIV NOT EQUAL LT ANDOP OROP XOROP
...
%left MUL DIV ANDOP OROP XOROP EQUAL ARROW  LT /* medium precedence */
%left ASSIGN              
/*
%nonassoc THEN    
%nonassoc ELSE    
...
| expr XOROP expr                    { Past.Op(get_loc(), $1, Past.XOR, $3) }
